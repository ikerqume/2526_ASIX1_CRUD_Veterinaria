...
if (isset($_POST['btn_editar_masc'])) {
    ...
    $sql = "UPDATE mascotas SET nombre=?, raza_id=?, propietario_id=?, veterinario_id=? WHERE chip=?";
    ...
    // Orden: nombre(s), raza_id(i), propietario_id(i), veterinario_id(i), chip(s)
    mysqli_stmt_bind_param($stmt, "siiis", $nombre, $id_raza, $id_prop, $id_vet, $chip);
